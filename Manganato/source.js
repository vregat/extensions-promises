...
class Manganato extends paperback_extensions_common_1.Source {
    ...
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return ManganatoParser_1.parseMangaDetails($, mangaId);
        });
    }
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            return ManganatoParser_1.parseChapters($, mangaId);
        });
    }
    getChapterDetails(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            return ManganatoParser_1.parseChapterDetails($, mangaId, chapterId);
        });
    }
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            ManganatoParser_1.parseHomeSections($, sections, sectionCallback);
        });
    }
    searchRequest(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const search = ManganatoParser_1.generateSearch(query);
            const request = createRequestObject({
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            const manga = ManganatoParser_1.parseSearch($);
            metadata = !ManganatoParser_1.isLastPage($) ? { page: page + 1 } : undefined;
    ...
    getTags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            return ManganatoParser_1.parseTags($);
        });
    }
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            const manga = ManganatoParser_1.parseViewMore($);
            metadata = !ManganatoParser_1.isLastPage($) ? { page: page + 1 } : undefined;
            return createPagedResults({
                results: manga,
                metadata
...
},{"./ManganatoParser":27,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.parseChapters = ($, mangaId) => {
    ...
    for (let chapter of $('li', allChapters).toArray()) {
        ...
        const chapNum = Number((_d = (_c = /Chapter ([0-9]\d*(\.\d+)?)/g.exec(name)) === null || _c === void 0 ? void 0 : _c[1]) !== null && _d !== void 0 ? _d : '');
...
exports.parseHomeSections = ($, sections, sectionCallback) => {
    ...
    for (const item of $('.content-homepage-item', '.panel-content-homepage').toArray()) {
        const id = (_c = $('a', item).first().attr('href')) !== null && _c !== void 0 ? _c : '';
    ...
    for (const item of $('a', '.panel-newest-content').toArray()) {
        const id = (_e = $(item).attr('href')) !== null && _e !== void 0 ? _e : '';
        const image = (_f = $('img', item).attr('src')) !== null && _f !== void 0 ? _f : '';
        const title = (_g = $('img', item).attr('alt')) !== null && _g !== void 0 ? _g : '';
...
exports.parseSearch = ($) => {
    ...
    for (const item of items) {
        const id = (_a = $('.genres-item-name', item).attr('href')) !== null && _a !== void 0 ? _a : '';
        const title = $('.genres-item-name', item).text();
        const subTitle = $('.genres-item-chap', item).text();
        const image = (_b = $('.img-loading', item).attr('src')) !== null && _b !== void 0 ? _b : '';
