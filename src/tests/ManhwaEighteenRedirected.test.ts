...
import { ManhwaEighteenRedirected } from "../sources/ManhwaEighteenRedirected/ManhwaEighteenRedirected";

describe('ManhwaEighteen Redirected Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: Source = new ManhwaEighteenRedirected(cheerio);
