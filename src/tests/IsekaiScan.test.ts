...
import { IsekaiScan } from "../sources/IsekaiScan/IsekaiScan";

describe('IsekaiScan Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: Source = new IsekaiScan(cheerio);
    ...
    it("Retrieve Manga Details", async () => {
        ...
        expect(data.avgRating, "Missing Rating").to.exist;
    });
