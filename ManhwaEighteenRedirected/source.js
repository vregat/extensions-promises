...
class ManhwaEighteenRedirected extends Source_1.Source {
    constructor(cheerio) {
        super(cheerio);
    }
    ...
    getMangaShareUrl(mangaId) { return `${ME_DOMAIN}/manga/${mangaId}.html`; }
...
exports.ManhwaEighteenRedirected = ManhwaEighteenRedirected;
